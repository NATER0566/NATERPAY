...
async function processVTURequest(type, data) {
  ...
  if (type === 'airtime') {
      ...
      // [CRITICAL FIX]: Spectranet and Smile require the actual Account ID in billersCode, NOT the 08011111111 sandbox override
      if (data.network === 'spectranet' || data.network === 'smile-direct') {
          payload.billersCode = data.phone; 
          payload.phone = isSandbox ? '08011111111' : '08000000000';
      } else {
